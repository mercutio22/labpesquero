...
ADMINS = (
     ('The Boss', 'your_email@example.com'),
)
...
SECRET_KEY = 'h_1hrsufuxvgc52yape1sltgf#cx8&amp;j8uxv9sj3!(kckld4v_t'
...
WSGI_APPLICATION = 'labpesquero.wsgi.application'
...
# See sample file at settings_local-EXAMPLE.include.
...
execfile(os.path.join(PROJECT_DIR,'settings_local.include'))
